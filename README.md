...
`${GOPATH}/src/github.com/ronaudinho/hnbeat`
...
```
git remote set-url origin https://github.com/ronaudinho/hnbeat
...
in the same directory with the name hnbeat.
...
```
mkdir -p ${GOPATH}/src/github.com/ronaudinho/hnbeat
git clone https://github.com/ronaudinho/hnbeat ${GOPATH}/src/github.com/ronaudinho/hnbeat
```
